...
import useFetchProductsById from '../../../lib/hooks/useFetchProductsByID';
import classes from './Cart.module.css';
import { toggle } from '../../../lib/store/popup/popup';
import { useState } from 'react';
import { Product } from '../../../lib/types/product';
import { removeCart } from '@/lib/store/cart/cart';
            ...
            {showCheckout ? (
              <>
                <form method="post" className={classes.form} action="">
                  ...
                  <input type="text" name="falst_name" id="" />
              ...
              <>
                {products.map((product, index) => (
                  <div className={classes.wrapperProduct}>
                    ...
                    <button onClick={() => removeBtnClick(product)}>
                      Remove
                    </button>
                  </div>
                ))}
